// Rust by example
// @link https://doc.rust-lang.org/stable/rust-by-example/hello/print.html
use std::f64::consts;
pub fn main() {
    println!("Rough estimate of PI: {pi:.3}", pi = consts::PI);
    ...
    println!("{number:x>5}", number = 2);

    // You can use named arguments in the format specifier by appending a `$`
    println!("{number:0>width$}", number = 7, width = 5);
